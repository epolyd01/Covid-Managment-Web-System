...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <title>Covid Positive</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Covid-Positive.css" media="screen">
    ...
    <meta property="og:title" content="Covid Positive">
  ...
  <body class="u-body u-stick-footer u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-62ab"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-valign-middle-lg u-valign-middle-md u-valign-middle-xl u-section-1" id="sec-d304">
    ...
    <section class="u-align-center u-clearfix u-section-2" id="sec-af75">
      <div class="u-clearfix u-sheet u-valign-bottom-lg u-valign-bottom-md u-valign-bottom-xl u-sheet-1">
        <p class="u-align-left u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1">Tested positive to covid</p>
      </div>
    </section>
    <section class="u-clearfix u-section-3" id="sec-7a8f">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-left u-expanded-width-xs u-form u-form-1">
          ...
          <div class="u-form-date u-form-group u-label-top u-form-group-1">
            <label for="date-b312" class="u-label">Date of Positive Test</label>
            <input type="date" placeholder="DD/MM/YYYY" id="date-b312" name="positiveTestDate" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-input-1">
          </div>
        </div>
        <div class="u-align-right u-expanded-width-xs u-form u-form-2">
          ...
          <div class="u-form-date u-form-group u-label-top u-form-group-2">
            <label for="date-a9f6" class="u-label">Release Date</label>
            <input type="date" placeholder="DD/MM/YYYY" id="date-a9f6" name="releaseDate" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-input-2">
          </div>
        </div>
      </div>
    </section>
    <section class="u-clearfix u-section-4" id="sec-e71a">
      <div class="u-clearfix u-sheet u-sheet-1">
        <a href="Covid-Positive.php" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1">save</a>
      </div>
    </section>
