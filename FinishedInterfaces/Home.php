...
<link rel="stylesheet" href="Home.css" media="screen">
  ...
  <body class="u-body u-stick-footer u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-62ab"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-valign-bottom-md u-valign-bottom-sm u-section-1" id="sec-2f7b">
  ...
  <?php
    ...
    $sql = "SELECT name AS N, surname AS S FROM User WHERE username='$usern'";
...
<h6 class="u-text u-text-default u-text-2"><br><br>Welcome, <?php echo $name?>  <?php echo $surname?>&nbsp;&nbsp;</h6>

    <div class="u-rotation-parent u-valign-bottom-md u-valign-bottom-sm u-valign-bottom-xs u-rotation-parent-1" >
    <img class="u-align-left-md u-align-left-sm u-align-left-xs u-flip-horizontal u-image u-image-contain u-image-default u-rotate-180" src="images/Screenshot2022-11-18132124.jpg" alt="" data-image-width="475" data-image-height="326" width=100%> <!-- u-image-1-->
    </div>
    </section>
