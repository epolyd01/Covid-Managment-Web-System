...
<link rel="stylesheet" href="Close-Contact.css" media="screen">
  ...
  <body class="u-body u-stick-footer u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-62ab"><div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="u-clearfix u-sheet u-valign-bottom-lg u-valign-bottom-md u-valign-bottom-xl u-sheet-1">
        <p class="u-align-left u-text u-text-default-lg u-text-default-md u-text-default-sm u-text-default-xl u-text-1" style="text-transform: uppercase; font-weight: bold;">Close contact</p>
      </div>
    </section>
    ...
    if(isset($_POST['save_closeContact'])) {
       $date = $_POST['contactDate'];
       $releaseDate = $_POST['releaseDate'];

       $sql2 = "UPDATE CloseContact".
...
<form method="post">
    ...
    <section class="u-clearfix u-section-4" id="sec-421e">
      <div class="u-clearfix u-sheet u-sheet-1">
      <input type="submit" value="save" name="save_closeContact" class="u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1">
      </div>
    </section>
    </div>
    </form>
